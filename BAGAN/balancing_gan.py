...
from tensorflow.keras.layers import (
    Input, Dense, Reshape, Flatten, Embedding, Dropout,
    UpSampling2D, Conv2D, LeakyReLU
)
    ...
    def init_autoenc(self, bg_train, gen_fname=None, rec_fname=None):
        ...
        if not multivariate_prelearnt:
            ...
            for c in range(self.nclasses):
                ...
                print(f"BAGAN: computing latent stats for class {c + 1}/{self.nclasses} ({len(imgs)} images)")
